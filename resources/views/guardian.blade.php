<x-layout>
    ...
    <h1 class="mb-4 font-bold text-3xl text-black">Guardian Page</h1>
        ...
        <table class="table-auto w-full border-collapse min-w-max">
            <thead>
                <tr class="bg-gradient-to-r from-blue-100 to-blue-300 text-blue-900">
                    ...
                    <th class="border-b-2 border-blue-300 px-6 py-3 text-left font-semibold">Job</th>
                    <th class="border-b-2 border-blue-300 px-6 py-3 text-left font-semibold">Phone</th>
            ...
            <tbody>
                @foreach($guardian as $g)
                    <tr class="hover:bg-blue-50 transition">
                        ...
                        <td class="border-t px-6 py-4">{{ $g['name'] }}</td>
                        <td class="border-t px-6 py-4">{{ $g['job'] }}</td>
                        <td class="border-t px-6 py-4">{{ $g['phone'] }}</td>
                        <td class="border-t px-6 py-4">{{ $g['email'] }}</td>
                        <td class="border-t px-6 py-4">{{ $g['address'] }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
