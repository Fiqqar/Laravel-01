<x-layout>
    ...
    <h1 class="mb-4 font-bold text-3xl text-black">Teacher Page</h1>
        ...
        <table class="table-auto w-full border-collapse min-w-max">
            <thead>
                <tr class="bg-gradient-to-r from-blue-100 to-blue-300 text-blue-900">
                    ...
                    <th class="border-b-2 border-blue-300 px-6 py-3 text-left font-semibold">Subject</th>
            ...
            <tbody>
                @foreach($teacher as $t)
                    <tr class="hover:bg-blue-50 transition">
                        ...
                        <td class="border-t px-6 py-4">{{ $t->name }}</td>
                        <td class="border-t px-6 py-4">{{ $t->subject->name }}</td>
                        <td class="border-t px-6 py-4">{{ $t->phone }}</td>
                        <td class="border-t px-6 py-4">{{ $t->address }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
